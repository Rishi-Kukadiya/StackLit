...
//         <main className="flex-1 flex justify-center py-6 px-4 lg:px-8">
//           <div className="w-full max-w-2xl">
//             {/* Form Container - Better Centered */}
//             <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden mx-auto">
//               {/* Header */}
//               <div className="bg-gradient-to-r from-[#2E236C]/80 to-[#433D8B]/80 px-6 py-8 text-center border-b border-white/20">
...
//               <div className="p-6 max-h-[calc(100vh-180px)] overflow-y-auto scrollbar-custom">
...
//                   <div className="pt-4  bottom-0 bg-gradient-to-t from-white/10 to-transparent backdrop-blur-sm">
//                     <button
//                       type="submit"
//                       className="w-full bg-gradient-to-r from-[#C8ACD6] to-[#433D8B] hover:from-[#C8ACD6]/90 hover:to-[#433D8B]/90 text-white py-4 rounded-2xl font-bold text-lg shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
//                       disabled={loading}
//                     >
...
//                 {/* Messages */}
//                 {error && (
//                   <div className="mt-4 p-4 bg-red-500/20 border border-red-500/30 rounded-2xl text-red-200 text-center font-semibold backdrop-blur-sm">
//                     {error}
//                   </div>
//                 )}

//                 {success && (
//                   <div className="mt-4 p-4 bg-green-500/20 border border-green-500/30 rounded-2xl text-green-200 text-center font-semibold backdrop-blur-sm">
//                     {success}
//                   </div>
//                 )}
//               </div>
...
//           scrollbar-color: rgba(200, 172, 214, 0.5) transparent;
//         }
...
//           background: rgba(200, 172, 214, 0.6);
//           border-radius: 10px;
//         }

//         .scrollbar-custom::-webkit-scrollbar-thumb:hover {
//           background: rgba(200, 172, 214, 0.8);
//         }
//       `}</style>
//     </div>
//   );
