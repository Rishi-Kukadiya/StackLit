  ...
  return (
    <div className="relative w-full h-full flex flex-col bg-[#1a133a] text-white">
      ...
      <div className="flex items-center justify-between p-4 border-b border-[#433D8B]/30 sticky top-0 bg-[#1a133a] z-10">
        <h1 className="text-2xl font-bold text-white">Modify Your Question</h1>
        <button
          onClick={onClose}
          className="text-white bg-[#433D8B] rounded-full p-2 hover:bg-[#2E236C] transition-colors"
          aria-label="Close"
        >
          <X className="w-6 h-6" />
        </button>
          ...
          {editingField === "title" ? (
            <div>
              <input
                ...
                className="w-full rounded-lg px-3 py-2 bg-[#2E236C]/70 text-white border border-[#433D8B] focus:ring-2 focus:ring-[#C8ACD6] focus:outline-none"
                autoFocus
              />
              <div className="flex gap-3 mt-3">
                <ActionButton onClick={() => handleSave("title")}>
            ...
            <p className="text-white text-lg font-medium">{editTitle}</p>
          )}
        </SectionWrapper>
        ...
        <div className="bg-red-900/30 border border-red-500/50 rounded-lg p-4 flex items-center justify-between">
          <div>
            ...
            <p className="text-red-300/80 text-sm mt-1">
              Deleting your question is permanent and cannot be undone.
            </p>
          </div>
          <ActionButton onClick={handleDeleteQuestion} variant="danger">
